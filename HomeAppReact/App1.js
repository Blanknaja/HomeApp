...
class HomeScreen extends React.Component {
  ...
  handelgetData(item) {
    ...
    console.log(
      "Token from first Page = " + this.props.navigation.state.params.Token
    );
    console.log(
      "Latitude from first Page =  " +
        this.props.navigation.state.params.latitudeUser
    );
    console.log(
      "Longtitude from first Page =  " +
